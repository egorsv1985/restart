(() => {
  ...
  function o() {
    ...
    e &&
      e.addEventListener("click", function (e) {
        i && (r(), document.documentElement.classList.toggle("open"));
      });
  }
  function l(e) {
    setTimeout(() => {
    ...
    if (r) {
      ...
      if (
        (document.documentElement.classList.contains("menu-open") &&
          (n(), document.documentElement.classList.remove("open")),
          ...
          void 0 !== r &&
            ...
            (y(t[i]) && y(n[i])
              ? n[i].__swiper__
                ...
                : T(t[i], n[i])
              : !y(t[i]) && y(n[i])
              ? ((t[i] = {}), n[i].__swiper__ ? (t[i] = n[i]) : T(t[i], n[i]))
              : (t[i] = n[i]));
        }
      }
    }
  ...
  const B = {
    ...
    updateSlides: function () {
      ...
      const i = e.params,
        ...
        p = L(n, `.${e.params.slideClass}, swiper-slide`),
      ...
      for (let r = 0; r < u; r += 1) {
        ...
        if (
          ((P = 0),
          p[r] && (n = p[r]),
          C && e.grid.updateSlide(r, n, u, t),
          !p[r] || "none" !== A(n, "display"))
        ) {
          if ("auto" === i.slidesPerView) {
            ...
            (P = (a - (i.slidesPerView - 1) * S) / i.slidesPerView),
              i.roundLengths && (P = Math.floor(P)),
      ...
      if (
        ...
        C && e.grid.updateWrapperSize(P, h, t),
        !i.centeredSlides)
      ) {
        const t = [];
    ...
    updateSlidesClasses: function () {
      const e = this,
        ...
        a = (e) => L(i, `.${s.slideClass}${e}, swiper-slide${e}`)[0];
      let o;
      if (
        (t.forEach((e) => {
          e.classList.remove(
  ...
  function H(e) {
    ...
    const T = y && t.allowTouchMove && n.touchStartPreventDefault;
  ...
  function N(e) {
    ...
    for (
      ...
      void 0 !== o[e + t]
        ? u >= o[e] && u < o[e + t] && ((h = e), (f = o[e + t] - o[e]))
        : u >= o[e] && ((h = e), (f = o[o.length - 1] - o[o.length - 2]));
    }
    let m = null,
      g = null;
    r.rewind &&
    ...
    if (p > r.longSwipesMs) {
      ...
      "next" === t.swipeDirection &&
        (v >= r.longSwipesRatio
          ? t.slideTo(r.rewind && t.isEnd ? m : h + S)
          : t.slideTo(h)),
      ...
      (d.target === t.navigation.nextEl || d.target === t.navigation.prevEl)
        ? d.target === t.navigation.nextEl
          ? t.slideTo(h + S)
          : t.slideTo(h)
        : ("next" === t.swipeDirection && t.slideTo(null !== m ? m : h + S),
      ...
      events: {
        attachEvents: function () {
          ...
          (e.onTouchStart = H.bind(e)),
            ...
            (e.onClick = Y.bind(e)),
            (e.onLoad = K.bind(e)),
            Z || (t.addEventListener("touchstart", Q), (Z = !0)),
            J(e, "on");
        },
    ...
    !(function () {
      le(),
        document.querySelector(".trainerSwiper") &&
          new ae(".trainerSwiper", {
            slidesPerView: 5,
            spaceBetween: 10,
            breakpoints: {},
          }),
        document.querySelector(".gallerySwiper") &&
          new ae(".gallerySwiper", {
            navigation: {
  ...
  const fe = [...document.querySelector("#tablist").querySelectorAll(".tab")],
    me = [...document.querySelectorAll(".tabpanel")],
    ge = (e) => {
      const t = e.id;
      me.forEach((e) => {
        e.hidden = "true";
      ...
      document
        .querySelector(`[aria-labelledby="${t}"]`)
        .removeAttribute("hidden");
    },
    ve = (e) => {
      const t = e.id;
      me[0].classList.remove("visible"),
        fe.forEach((e) => {
          e.getAttribute("id") === t
  ...
  fe.forEach((e) => {
    ...
    fe.forEach((e) => {
      e.addEventListener("keydown", function (t) {
        32 === (t.keyCode || t.which) && (ve(e), ge(e), e.click());
      });
    }),
    (() => {
      const e = fe[0],
      ...
      fe.forEach((s) => {
        s.addEventListener("keydown", function (i) {
          if (38 === (i.keyCode || i.which) || 37 === (i.keyCode || i.which))
            if (s == e) i.preventDefault(), t.focus();
            else {
              i.preventDefault();
              const e = fe.indexOf(s) - 1;
              fe[e].focus();
            }
          else if (
            40 === (i.keyCode || i.which) ||
            39 === (i.keyCode || i.which)
          )
            if (s == t) i.preventDefault(), e.focus();
            else {
              i.preventDefault();
              const e = fe.indexOf(s) + 1;
              fe[e].focus();
    ...
    (window.onload = () => {
      fe.forEach((e) => {
        ...
        -1 === window.location.href.indexOf("#panel")
          ? (fe[0].setAttribute("tabindex", "0"),
            fe[0].setAttribute("aria-selected", "true"),
            me[0].classList.add("visible"))
          : (() => {
              const e = document
  ...
  const we = document.querySelectorAll(".cards__box");
  we.forEach((e) => {
    e.addEventListener("click", function () {
      we.forEach((e) => e.classList.remove("active")),
